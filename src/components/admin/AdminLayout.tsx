      ...
      <div className="min-h-screen bg-[#050505] flex items-center justify-center">
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="text-center">
            <h2 className="text-[10px] font-sans font-black tracking-[0.4em] text-white/40 animate-pulse">
      ...
      <div className="min-h-screen bg-[#050505] flex items-center justify-center px-6 py-20">
        <div className="max-w-2xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 bg-[#080808] border border-white/10 p-8 md:p-12 relative overflow-hidden shadow-[0_0_100px_rgba(0,0,0,0.8)]">
          ...
          <div className="flex flex-col justify-center relative">
            ...
            <h1 className="text-4xl font-black tracking-tighter mb-4 italic text-white text-glow leading-none">Vanguard <br />portal.</h1>
            ...
            <div className="flex items-center gap-3 text-[10px] font-sans font-black tracking-[0.2em] text-white/20">
            ...
            {user && !isAdmin ? (
              <div className="space-y-6">
                <div className="p-6 bg-red-500/5 border border-red-500/10 rounded-sm">
                  <h3 className="text-red-500 font-sans font-black text-[12px] tracking-widest mb-2 flex items-center gap-2">
                    <AlertTriangle size={14} />
                    Clearance denied
                  </h3>
                  <p className="text-white/40 text-[10px] font-sans font-bold tracking-wider leading-relaxed">
                ...
                <button 
                  onClick={() => signOut()}
                  className="w-full border border-white/10 text-white py-4 font-sans font-black tracking-widest text-[11px] hover:bg-white hover:text-dark transition-all flex items-center justify-center gap-3"
                >
                  Terminate & exit
                </button>
              </div>
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <h2 className="text-[10px] font-sans font-black tracking-[0.3em] text-white/60 mb-2 italic">
                    Fast track access
                  </h2>
                  <button 
                    type="button"
                    onClick={() => signInGoogle()}
                    className="w-full bg-white text-dark py-4 font-sans font-black tracking-widest text-[11px] hover:bg-accent hover:text-white transition-all shadow-[0_0_30px_rgba(255,255,255,0.1)] flex items-center justify-center gap-3 group"
                  >
                ...
                <div className="relative flex items-center py-2">
                  ...
                  <span className="flex-grow-0 mx-4 text-[9px] font-sans font-black text-white/5 tracking-[0.4em]">Alternative</span>
                  <div className="flex-grow border-t border-white/5"></div>
                </div>
                ...
                <form onSubmit={handleAuth} className="space-y-4">
                  <div className="flex items-center justify-between">
                    <h2 className="text-[10px] font-sans font-black tracking-[0.3em] text-white/40 italic">
                    ...
                    {loginEmail.toLowerCase() === 'haseeb.49251@gmail.com' && (
                      <button 
                        ...
                        className="text-[9px] font-sans font-bold tracking-widest text-accent hover:underline decoration-accent/30 underline-offset-4"
                      >
                  ...
                  <AnimatePresence>
                    {authError && (
                      ...
                      >
                        ...
                        <p className="text-[9px] font-sans font-bold tracking-widest">{authError}</p>
                      </motion.div>
                    )}
                  </AnimatePresence>
                  ...
                  <button 
                    ...
                    className={`w-full ${isEnrollMode ? 'bg-accent text-white' : 'border border-white/10 text-white/60'} py-3 font-sans font-black tracking-widest text-[10px] hover:bg-white hover:text-dark transition-all disabled:opacity-50`}
                  >
                    {isAuthenticating ? (
          ...
          <p className="col-span-full mt-12 text-center text-[9px] font-sans font-bold text-white/10 tracking-[0.4em]">
      ...
      >
        ...
        <div className="h-20 flex items-center px-6 border-b border-white/10">
          <Link to="/" className="flex items-center gap-3 group">
            ...
            {isSidebarOpen && (
              <span className="font-black italic tracking-tighter text-xl group-hover:text-accent transition-colors">Vanguard.</span>
            )}
          </Link>
        </div>
          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                {isSidebarOpen && (
                  <span className="font-sans font-black text-[11px] tracking-[0.2em]">{item.name}</span>
                )}
                {isActive && (
                  <motion.div 
        ...
        <div className="p-4 border-t border-white/10">
          ...
          >
            <LogOut size={20} />
            {isSidebarOpen && (
              <span className="font-sans font-black text-[11px] tracking-[0.2em]">Terminate session</span>
            )}
          </button>
        </div>
        ...
        <header className="h-20 border-b border-white/10 bg-[#080808]/80 backdrop-blur-xl px-8 flex items-center justify-between z-40 shrink-0">
          <div className="flex items-center gap-4">
            <div className="relative hidden md:block">
              ...
              <input 
                ...
                className="bg-white/5 border border-white/10 pl-12 pr-4 py-2.5 w-64 font-sans text-[9px] tracking-widest font-bold outline-none focus:border-accent transition-all"
              />
            </div>
          </div>
          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[9px] font-sans font-black tracking-widest text-white/20">Live engine safe</span>
            </div>
            ...
            <div className="flex items-center gap-4 group cursor-pointer">
              <div className="text-right hidden sm:block">
                <span className="block text-[10px] font-sans font-black tracking-widest leading-none mb-1">{user.displayName}</span>
                <span className="block text-[9px] font-sans font-bold text-accent tracking-widest opacity-60">Operations unit</span>
              </div>
            ...
            >
              <LogOut size={16} />
              <span className="absolute -bottom-8 left-1/2 -translate-x-1/2 bg-red-500 text-white text-[8px] font-black tracking-widest px-2 py-1 opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
                Terminate
              </span>
            </button>
          </div>
