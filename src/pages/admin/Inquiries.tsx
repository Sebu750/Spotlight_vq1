      ...
      {showDetailsModal && selectedInquiry && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center px-6">
          ...
          <div className="bg-zinc-900 border border-white/10 w-full max-w-2xl p-8 md:p-12 relative z-10 max-h-[90vh] overflow-y-auto">
            ...
            <h2 className="text-4xl font-black uppercase tracking-tighter mb-8 leading-none">INQUIRY <br /><span className="text-accent italic">DETAILS</span></h2>
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4 pt-6 border-t border-white/10">
                <a 
                  ...
                  className="flex-1 bg-accent/10 text-accent border border-accent/20 py-4 font-sans font-black uppercase tracking-widest text-[10px] hover:bg-accent hover:text-white transition-all text-center"
                >
                  <Mail size={14} className="inline mr-2" /> Reply via Email
                </a>
                <button 
